DROP TABLE IF EXISTS caracteristicasbar;
...
INSERT INTO favoritos (usuario, bar) VALUES ("pepe", "Kuik'AS");
...
INSERT INTO horario (bar, diaSemana, inicio, fin) VALUES ("Be Funky", "Sábado", TIME('20:00'), TIME('4:00'));

INSERT INTO horario (bar, diaSemana, inicio, fin) VALUES ("El tio molonio", "Lunes", TIME('10:00'), TIME('2:00'));
INSERT INTO horario (bar, diaSemana, inicio, fin) VALUES ("El tio molonio", "Martes", TIME('10:00'), TIME('2:00'));
INSERT INTO horario (bar, diaSemana, inicio, fin) VALUES ("El tio molonio", "Miércoles", TIME('10:00'), TIME('2:00'));
...
INSERT INTO horario (bar, diaSemana, inicio, fin) VALUES ("El tio molonio", "Sábado", TIME('10:00'), TIME('2:00'));
...
INSERT INTO horario (bar, diaSemana, inicio, fin) VALUES ("Kuik'AS", "Sábado", TIME('20:00'), TIME('4:00'));



CREATE TABLE caracteristicasbar(
    bar VARCHAR(50),
    caracteristica VARCHAR(20),
    PRIMARY KEY (bar, caracteristica),
    FOREIGN KEY (bar) REFERENCES bar(nombre)
);

INSERT INTO caracteristicasbar(bar, caracteristica) VALUES ("Kuik'AS", "Pedidos a domicilio");
INSERT INTO caracteristicasbar(bar, caracteristica) VALUES ("Kuik'AS", "Terraza");
INSERT INTO caracteristicasbar(bar, caracteristica) VALUES ("Kuik'AS", "Servicio de Terraza");

INSERT INTO caracteristicasbar(bar, caracteristica) VALUES ("El tio molonio", "Pedidos a domicilio");
INSERT INTO caracteristicasbar(bar, caracteristica) VALUES ("El tio molonio", "Terraza");
INSERT INTO caracteristicasbar(bar, caracteristica) VALUES ("El tio molonio", "Multiplanta");

INSERT INTO caracteristicasbar(bar, caracteristica) VALUES ("Be Funky", "Pedidos a domicilio");
INSERT INTO caracteristicasbar(bar, caracteristica) VALUES ("Be Funky", "Terraza");