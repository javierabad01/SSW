...
public class Registrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if((email.isBlank())||(username.isBlank())||(password.isBlank())||(passwordRepeat.isBlank())){
...
request.getSession().setAttribute("mensajeError", mensajeError);
                    ...
                    insertarUsuario(email, username, password, c);
    ...
    private void insertarUsuario(String email, String username, String password, Consultor c) {
        try {       
            ...
            values.add(username);
            values.add(password);
            ResultSet rs = c.realizarConsulta(sql, values);
